KManager.action :bootstrap do
  action do
    application_name = :kweb04_active_storage
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Sample Rails 7 application using activestorage for image upload',
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 '',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/kweb04-active-storage'
      )
      .github(
        active: true,
...
KManager.opts.app_name                    = 'kweb04-active-storage'
